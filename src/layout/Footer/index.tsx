...
const Footer: React.FC = () => {
  return (
    <>
      <footer
        className='wow fadeInUp bg-primary-cta bg-opacity-5 relative z-10 pt-16 md:pt-20 lg:pt-24'
        data-wow-delay='.1s'
      >
          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12'>
              <div className='mb-12 max-w-[360px] lg:mb-16'>
                ...
                <p className='text-body-color mb-9 text-base leading-relaxed font-medium'>
                ...
                <div className='flex items-center'>
                  <a
                    ...
                    className='hover:text-primary mr-6 text-[#CED3F6]'
                  >
                    <svg
                      width='9'
                      height='18'
              ...
              <div className='mb-12 lg:mb-16'>
                ...
                <ul>
                  <li>
                    <a
                      href='/'
                      className='text-body-color hover:text-primary mb-4 inline-block text-base font-medium'
                    >
                      {' '}
                      Blog{' '}
                    </a>
